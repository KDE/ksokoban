...
void MainWindow::createCollectionMenu(QMenu *collection_)
{
    ...
    for (int i = 0; i < internalCollections_.collections(); i++) {
        ...
        connect(qact, &QAction::triggered, this, [this, i]() {
            changeCollection(i);
        });
    ...
    , externalCollection_(nullptr)
{
    ...
    connect(qa_slow, &QAction::triggered, this, [this]() {
        updateAnim(3);
    });
    connect(qa_medium, &QAction::triggered, this, [this]() {
        updateAnim(2);
    });
    connect(qa_fast, &QAction::triggered, this, [this]() {
        updateAnim(1);
    });
    connect(qa_off, &QAction::triggered, this, [this]() {
        updateAnim(0);
    });
...
void MainWindow::updateAnim(int val)
{
    updateAnimMenu(val);
...
void MainWindow::updateAnimMenu(int id)
{
    switch (checkedAnim_) {
    case 0:
...
void MainWindow::setBookmark(int id)
{
    assert(id >= 1 && id <= 10);
...
void MainWindow::goToBookmark(int id)
{
    assert(id >= 1 && id <= 10);
